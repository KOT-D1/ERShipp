...
var require_accordion = __commonJS({
  "node_modules/@preline/accordion/index.js"(exports, module) {
    !function(t, e) {
      ...
      var t = { 740: function(t2, e2, n2) {
        ...
        var s = n2(292), l = function(t3) {
          ...
          return i(e3, t3), e3.prototype.init = function() {
            ...
            this.el.classList.add("active"), (null === (t4 = null == this ? void 0 : this.toggle) || void 0 === t4 ? void 0 : t4.ariaExpanded) && (this.toggle.ariaExpanded = "true"), this.content.style.display = "block", this.content.style.height = "0", setTimeout(function() {
              ...
              e4.content.style.display = "block", e4.content.style.height = "", e4.fireEvent("open", e4.el), (0, s.dispatch)("open.hs.accordion", e4.el, e4.el);
            });
            ...
            this.el.classList.remove("active"), (null === (t4 = null == this ? void 0 : this.toggle) || void 0 === t4 ? void 0 : t4.ariaExpanded) && (this.toggle.ariaExpanded = "false"), this.content.style.height = "".concat(this.content.scrollHeight, "px"), setTimeout(function() {
              ...
              e4.content.style.display = "", e4.content.style.height = "0", e4.fireEvent("close", e4.el), (0, s.dispatch)("close.hs.accordion", e4.el, e4.el);
            });
        ...
        }), "undefined" != typeof window && (window.HSAccordion = l), e2.default = l;
      }, 961: (t2, e2) => {
        Object.defineProperty(e2, "__esModule", { value: true });
        var n2 = function() {
        ...
        e2.isEnoughSpace = function(t3, e3, n3, o2, i2) {
          ...
          var r = e3.getBoundingClientRect(), c = i2 ? i2.getBoundingClientRect() : null, s = window.innerHeight, l = c ? r.top - c.top : r.top, a = (i2 ? c.bottom : s) - r.bottom, u = t3.clientHeight + o2;
          return "bottom" === n3 ? a >= u : "top" === n3 ? l >= u : l >= u || a >= u;
        };
      ...
      var n = function n2(o) {
        ...
        var r = e[o] = { exports: {} };
        return t[o].call(r.exports, r, r.exports, n2), r.exports;
      }(740);
      return n;
    })());
  }
...
@preline/accordion/index.js:
   ...
   *)
*/
//# sourceMappingURL=@preline_accordion_index__js.js.map
