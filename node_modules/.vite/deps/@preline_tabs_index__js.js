  ...
  "node_modules/@preline/tabs/index.js"(exports, module) {
    !function(t, e) {
      ...
      var t = { 223: (t2, e2) => {
        ...
        var o, r = this && this.__extends || (o = function(t3, e3) {
        ...
        Object.defineProperty(e2, "__esModule", { value: true });
        var s = n2(292), a = i(n2(961)), l = n2(223), c = function(t3) {
          function e3(e4, n3, o2) {
            var r2 = t3.call(this, e4, n3, o2) || this;
            return r2.toggles = r2.el.querySelectorAll("[data-hs-tab]"), r2.extraToggleId = r2.el.getAttribute("data-hs-tab-select"), r2.extraToggle = document.querySelector(r2.extraToggleId), r2.current = Array.from(r2.toggles).find(function(t4) {
              return t4.classList.contains("active");
            }), r2.currentContentId = r2.current.getAttribute("data-hs-tab"), r2.currentContent = document.querySelector(r2.currentContentId), r2.prev = null, r2.prevContentId = null, r2.prevContent = null, r2.init(), r2;
          }
          return r(e3, t3), e3.prototype.init = function() {
            var t4 = this;
            ...
            if (n3) {
              var o2 = t4 ? Array.from(n3.element.toggles).reverse() : Array.from(n3.element.toggles), r2 = o2.find(function(t5) {
                return document.activeElement === t5;
              }), i2 = o2.findIndex(function(t5) {
                return t5 === r2;
              });
              o2[i2 = i2 + 1 < o2.length ? i2 + 1 : 0].focus(), o2[i2].click();
            }
        ...
        e2.isEnoughSpace = function(t3, e3, n3, o2, r2) {
          void 0 === n3 && (n3 = "auto"), void 0 === o2 && (o2 = 10), void 0 === r2 && (r2 = null);
          var i = e3.getBoundingClientRect(), s = r2 ? r2.getBoundingClientRect() : null, a = window.innerHeight, l = s ? i.top - s.top : i.top, c = (r2 ? s.bottom : a) - i.bottom, u = t3.clientHeight + o2;
        ...
        var r = function(t3) {
          return !!t3 && ("none" === window.getComputedStyle(t3).display || r(t3.parentElement));
        };
        e2.isParentOrElementHidden = r;
        ...
        e2.afterTransition = function(t3, e3) {
          ...
          }, o2 = window.getComputedStyle(t3), r2 = o2.getPropertyValue("transition-duration");
          "none" !== o2.getPropertyValue("transition-property") && parseFloat(r2) > 0 ? t3.addEventListener("transitionend", n3, true) : e3();
        };
      ...
      var n = function n2(o) {
        ...
        var i = e[o] = { exports: {} };
        return t[o].call(i.exports, i, i.exports, n2), i.exports;
      }(166);
      return n;
    })());
  }
...
@preline/tabs/index.js:
   ...
   *)
*/
//# sourceMappingURL=@preline_tabs_index__js.js.map
